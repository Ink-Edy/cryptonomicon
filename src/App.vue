...
<script>
// [x] 6. Наличие в состоянии ЗАВИСИМЫХ ДАННЫХ
// [] 4. Запросы напрямую внутри компонента
// [] 2. При удалении остается подписка на закрузку тикеров (таймер)
// [] 5. Обработка ошибок API
// [] 3. Количество запросов
// [x] 8. При удалении тикера, не изменяется localStorage
// [x] 1. Одинаковый код в watch
// [] 9. localStorage и анонимные вкладки
// [] 7. график ужасно выглядит, если будет много цен
// [] 10. Магические строки и числа (URL, 5000 мс задержки, ключ localStorage, кол-во на странице)
...
export default {
  ...
  methods: {
    subscribeToUpdate(tickerName) {
      setInterval(async () => {
        const f = await fetch(
          `https://min-api.cryptocompare.com/data/price?fsym=${tickerName}&tsyms=USD&api_key=27afa71e82800602b971436dd22d06b02fcfd7405fdbdd9d094163916a82e7e3`
        );
